...
public abstract class MovingShape {
    ...
    public abstract class MovingPath {
        protected double deltaX, deltaY; // moving distance
    ...
    public class FallingPath extends MovingPath {
       ...
       */
       public void move() {
           ...
           topLeft.y = topLeft.y + (int)deltaY;
    ...
    public class BouncingPath extends MovingPath {
       ...
       */
       public void move() {
        ...
        /*
     *  ===============================================================================
     *  Circular Path: A Path that Moves a shape in a cicular motion.
     *  ===============================================================================
     */
    public class CircularPath extends MovingPath{
        private double angle = 0, speed = .1f;
        private int pathDirection = generateRandom();
        ...
        public void move(){
            if(pathDirection <= 5){
                angle-= 25.5;
                topLeft.x -= (10 * Math.sin(Math.toRadians(speed * angle)));
                topLeft.y -= (10 * Math.cos(Math.toRadians(speed * angle)));
                if (topLeft.y < 0) // if it reaches the bottom of the frame, start again from the top
