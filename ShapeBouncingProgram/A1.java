...
public class A1 extends JFrame {
    ...
    * @return toolsPanel        the Panel
    ...
    public JPanel setUpToolsPanel() {
        ...
        ImageIcon circularButtonIcon = createImageIcon("circular.gif");//Adds a button for the circular pattern.
        pathComboBox = new JComboBox<ImageIcon>(new ImageIcon[] {fallButtonIcon, bounceButtonIcon, circularButtonIcon});
